...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-02-2024 a las 12:08:07
...
(15, 'Billetera Croc', 'Billetera de cuero 100% color negra con detalles a', 21000, 120, 'billetera1.jpg', 'si', 1),
...
(18, 'Billetera Nivus Marron', 'Billetera de cuero 100% color marrón con detalles ', 21000, 151, 'billetera4.jpg', 'si', 9),
(19, 'Corbata Rayada Azul Oscuro', '100% Poliéster', 11000, 112, 'corbata1.jpg', 'si', 3),
(20, 'Corbata Puntos Bordo', '100% Poliéster', 11500, 78, 'corbata2.jpg', 'si', 3),
(21, 'Corbata Puntos Azul Claro', '100% Poliéster', 9900, 90, 'corbata3.jpg', 'si', 3),
(22, 'Corbata Cuadros Azul Oscuro', '100% Poliéster', 10500, 120, 'corbata4.jpg', 'si', 3),
(23, 'Reloj Rolex Acero Analogo ', 'Color de la malla: Plateado', 60000, 45, 'reloj2.jpg', 'si', 2),
(24, 'Reloj Analogo ', 'Malla de cuero de color negro', 45000, 40, 'reloj6.jpg', 'si', 1),
(25, 'Reloj Minimalista', 'Malla de acero color plata', 50000, 35, 'reloj5.jpg', 'si', 2),
(26, 'Reloj Analogo Acero Negro', 'Malla de acero color plata', 45000, 42, 'reloj3.jpg', 'si', 2),
(27, 'Gorra Snapback 6 ', 'Visera Plana Alta Calidad', 4500, 235, 'gorra1.png', 'si', 12),
(28, 'Gorro Piper O\'neill', 'Gorro piluso. Diametro 56 CM.', 12000, 35, 'gorra2.png', 'si', 12),
(29, 'Gorra BZRP', 'Cierre ajustable. Visera curvada.', 20000, 53, 'gorra3.png', 'si', 12),
(30, 'Anillo De Titanio', 'Material: Fabricado en carburo de titanio de alta ', 5100, 320, 'anillo.png', 'si', 14),
(31, 'Anillo Acero Quirúrgico', 'Acero quirúrgico esmaltado de excelente calidad.', 7400, 94, 'anillo2.png', 'si', 14),
(32, 'Anillo Acero Y Madera', 'Material: acero quirúrgico esmaltado y madera de e', 8000, 53, 'anillo3.png', 'si', 14),
(33, 'Pulsera Cuero& Acero', 'Material: Cuero Genuino / Dije en Acero Quirúrgico', 5500, 41, 'pulsera1.png', 'si', 10);
...
--
ALTER TABLE `detallefactura`
  MODIFY `Id_detalle_factura` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
