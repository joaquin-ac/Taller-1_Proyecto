...
<body class="d-flex flex-column min-vh-100">
        ...
        <nav class="navbar bg-dark navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
            <div class="container-fluid">
                <a class="navbar-brand p-1 m-3 me-2 mt-1 mb-1 rounded-circle" href="/Acevedo_ignacio/">
                    <img src="././assets/img/iconoPag.svg" onerror="this.style.display='none'" alt=""
                        style="height: 3.5rem">
                    <img src="../assets/img/iconoPag.svg" onerror="this.style.display='none'" alt=""
                        style="height: 3.5rem">
                </a>
                        ...
                        <ul class="navbar-nav ms-auto mb-1 ms-lg-0">
                            ...
                            <li class="my-auto">
                                <a class="nav-link link-success me-5" href="/Acevedo_ignacio/carrito">
                                    <img src="././assets/img/carrito.svg" onerror="this.style.display='none'"
                                        style="width: 2.5em" alt="carrito">
                                    <img src="../assets/img/carrito.svg" onerror="this.style.display='none'"
                                        style="width: 2.5em" alt="carrito">
                                </a>
                            </li>
    ...
    <section class="container">
        <div class="row mt-5 mb-5">
            ...
            <section class="mb-4 col-md-8 mx-auto">
                ...
                <!--Section heading-->
                <h1 class="h1-responsive font-weight-bold text-center mb-4">Contactanos</h1>
                <!--Section description-->
                <p class="text-center w-responsive mx-auto mb-5">¿Tiene alguna pregunta? No dude en
                    directamente con nosotros. Nuestro equipo le responderá en
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mb-md-0 mb-1">
                        <form id="contact-form" name="contact-form" action="/Acevedo_ignacio/contactos/enviar"
                            method="POST">
                            ...
                            <div class="text-center text-md-left">
                                <button class="btn btn-success shadow" style="width: 100%" type="submit">enviar</button>
                            </div>
                        </form>
                    ...
                    <!--Grid column-->
                    <div class="col-md-4 text-center aling-content-center">
                        <ul class="list-unstyled mb-0">
                            <li><i class="fas fa-map-marker-alt fa-2x"></i>
                                <p> <strong>Calle:</strong> 9 de Julio 1449</p>
                            </li>

                            <li><i class="fas fa-phone mt-4 fa-2x"></i>
                                <p><strong>Telefono:</strong> +54 01 234 567 89</p>
                            </li>

                            <li><i class="fas fa-envelope mt-4 fa-2x"></i>
                                <p><strong>Email:</strong> info@sartorialco.com</p>
                            </li>

                            <li><i class="fas fa-envelope mt-4 fa-2x"></i>
                                <p><strong>Propietario:</strong> Michael Scott</p>
                            </li>

                            <li><i class="fas fa-envelope mt-4 fa-2x"></i>
                                <p><strong>Razon social:</strong> Michael Scott & asociados S.A.</p>
                            </li>

                            <li>
                                <iframe
                                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d312.90183770669455!2d-58.83263749010944!3d-27.466763049386074!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94456dbd2402e577%3A0xaa62a22476dcaf95!2sIdiomas%20UNNE%2C%20Sede%20Corrientes!5e0!3m2!1ses-419!2sar!4v1686288451481!5m2!1ses-419!2sar"
    ...
    <script src="././assets/js/contact_form_validation.js" integrity="" cross origin=""></script>
