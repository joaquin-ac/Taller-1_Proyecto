...
<head>
    ...
    <link href="././assets/css/carrito.css" rel="stylesheet" integrity="" crossorigin="">
...
<body class="d-flex flex-column min-vh-100">
    ...
    <section>
        ...
        <div class="card my-5">
            <div class="row">
                <div class="col-md-8 cart ">
                    <div class="title">
                        <div class="row">
                            ...
                            <div class="col-5 ms-auto">
                                ...
                                <h4 class="ms-5"><b class="ms-3"> Subtotal</b></h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php foreach ($productos as $producto) { ?>
                        <div class="row border-top border-bottom">
                            <div class="row main align-items-center" style="height: 8rem">
                                <div class="col"><img class="img-fluid"
                                        src="././assets/img/productos/<?= $producto['url_imagen_producto'] ?>"></div>
                                <div class="col">
                                    <div class="row">
                                ...
                                <div class="col-auto">
                                    <a href="/Acevedo_ignacio/eliminarUnidadCarrito/<?= $producto['Id_producto'] ?>">-</a>
                                    <a class="border">
                                        <?= $producto['Cantidad_carrito'] ?>
                                    </a>
                                    <a href="/Acevedo_ignacio/agregarCarrito/<?= $producto['Id_producto'] ?>">+</a>
                                </div>
                                <div class="col-4 row justify-content-end">
                                    <a class="col-auto">
                                        &dollar;
                                        <?= number_format($producto['Precio_producto'] * $producto['Cantidad_carrito'], 2, ',', '.') ?>
                                    </a>
                                    <a href="/Acevedo_ignacio/eliminarCarrito/<?= $producto['Id_producto'] ?>"
                                        class="close col-1 align-self-center">&#10005;</a>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    <div class="row d-flex align-items-end justify-content-between mt-5">
                        <a href="/Acevedo_ignacio/catalogo" class="col-sm-auto">&leftarrow; <span
                                class="text-muted">Volver
                                al catalogo</span>
                        </a>
                        <a href="/Acevedo_ignacio/vaciarCarrito" class="col-sm-auto  d-flex">
                            <i class="material-icons" data-toggle="tooltip" title="Delete"></i>
                            <span class="text-muted">Vaciar Carrito</span>
                        </a>
                    </div>
                </div>
                <div class="col-md-4 summary">
                    <div>
                        ...
                        <div class="row">
                            ...
                            foreach ($productos as $producto) {
                                $subtotal += $producto['Cantidad_carrito'] * $producto['Precio_producto'];
                                $items += $producto['Cantidad_carrito'];
                            }
                            ?>
                    ...
                    <form action="/Acevedo_ignacio/facturacion" method="post">
                        <p>Metodo de pago</p>
                        <select name="metodoPago" id="metodoPago">
                            <option value="Tarjeta de Debito" class="text-muted">Tarjeta de Debito</option>
                            <option value="Tarjeta de Credito" class="text-muted">Tarjeta de Credito</option>
                        </select>
                        <input type="number" name="numeroTarjeta" id="numeroTarjeta" placeholder="Nro. de tarjeta"
                            required>
                        ...
                        <button class="btn btn-cart" type="submit">Confirmar compra</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <?php if (count($productos) > 0): ?>
            <div id="addProductModal" class="modal fade" onclick=" location.href = '/Acevedo_ignacio/vaciarCarrito' ">
                <div class="modal-dialog">
                    <div class="modal-content" style="overflow:hidden ">
                        <div class="justify-content-center">
                            <h1 class="mt-5 mx-5 text-center">Su compra se ha realizado con exito!</h1>
                            <div class="justify-content-center d-flex">
                                <a href="/Acevedo_ignacio/vaciarCarrito">
                                    <button class="my-5 btn-success btn justify-content-center d-flex text-center"
                                        role="button" class="text-white">Continuar
                                    </button>
                                </a>
                            </div>
                        </div>
        ...
        <?php else: ?>
            <div id="addProductModal" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content" style="overflow:hidden ">
                        <div class="justify-content-center">
                            <h1 class="mt-5 mx-5 text-center">Debe tener al menos un producto para poder comprar</h1>
                            <div class="justify-content-center d-flex">
                                <a href="">
                                    <button class="my-5 btn-success btn justify-content-center d-flex text-center"
                                        role="button" class="text-white">Continuar
    ...
    <script>
        ...
        envio.addEventListener("change", function () {
            selected = envio.options[envio.selectedIndex].value;
            if (selected == "envio_1500") {
                document.getElementById("envio_1500").classList.remove('d-none');
                document.getElementById("envio_gratis").classList.add('d-none')
            } else {
                document.getElementById("envio_gratis").classList.remove('d-none');
                document.getElementById("envio_1500").classList.add('d-none')
            }
