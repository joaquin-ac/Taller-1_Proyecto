                    ...
                    <div class="row">
                        ...
                        <form class="form-inline col-lg-4 col-sm-4 pt-2" action="" method="get">
                            <div class="input-group">
                                <input name="nombre" id="nombre" placeholder="Buscar consulta..." type="search"
                        ...
                        <div class="col-sm-6">
                            <div class="row ms-5">
                                ...
                                <a href="/Acevedo_ignacio/consultas/si" class="btn btn-secondary col-3"><span>Mostrar
                                        consultas
                                        vistas</span></a>
                                <a href="/Acevedo_ignacio/consultas/no"
                                    class="btn btn-secondary me-5 col-3"><span>Mostrar
                                        consultas
                                        no vistas</span></a>
                            </div>
                        </div>
                    ...
                    <tbody>
                        <?php foreach ($consultas as $consulta) { ?>
                            <tr>
                                ...
                                <td>
                                    <?= $consulta['Visto_consulta'] ?>
                                </td>

                                <td>
                                    <a href='/Acevedo_ignacio/visualizarConsulta/<?= $consulta['Id_consulta'] ?>'
                                        data-delete_id="<?= $consulta['Id_consulta'] ?>" class="" data-toggle="">
                                        <i class="bi bi-eye"></i>
                                    </a>

                                    <a href='/Acevedo_ignacio/borrarConsulta/<?= $consulta['Id_consulta'] ?>'
                                        data-delete_id="<?= $consulta['Id_consulta'] ?>" class="delete" data-toggle="">
